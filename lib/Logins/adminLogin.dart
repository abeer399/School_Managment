...
import 'package:aptech_e_project/Modules/adminModule.dart';
  ...
  checkUser() async {
    ...
    if (user != null) {
      Navigator.of(context)
          .push(MaterialPageRoute(builder: (ctx) => AdminModule(user)));
    }
  }
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text("ADMIN LOGIN",style: TextStyle(fontFamily: "Montserrat",fontWeight: FontWeight.bold,fontSize: 34,color: Colors.white),),
              ),
